        ...
        <div className="bg-neutral-800/60 backdrop-blur-sm border border-neutral-700/50 rounded-2xl p-8 shadow-2xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-gray-400">
              Folytatáshoz jelentkezz be a fiókodba
            </p>
          </div>
          ...
          <button
            ...
            className="
              ...
              border border-neutral-600/50 hover:border-teal-700/60
          ...
          <p className="mt-6 text-center text-xs text-gray-600 leading-relaxed">
            ...
            <span className="text-teal-600 hover:text-teal-400 cursor-pointer transition-colors">
