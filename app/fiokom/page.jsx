...
export default function UserDashboard() {
  ...
  return (
    <div className="user-dashboard flex flex-col md:flex-row gap-3 w-[100%] p-[10px] md:w-[80%] max-w-[1800px] my-[50px] mx-auto min-h-[100vh] items-start">
      <div className="user-dashboard-nav w-[100%] grid grid-cols-3 md:w-[250px] md:flex md:flex-col gap-3 px-2.5 py-[25px] bg-neutral-900/70 rounded-lg overflow-y-auto ">
        <div
          onClick={() => signOut()}
