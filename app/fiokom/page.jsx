...
export default function UserDashboard() {
  ...
  return (
    <div className="user-dashboard flex flex-col md:flex-row gap-3 w-[100%] bg-neutral-900  min-h-[100vh] items-start px-4 py-4">
      <div className="user-dashboard-nav w-[100%] sticky top-[75px] rounded-xl border border-neutral-600/80 grid grid-cols-1 md:grid-cols-3 md:w-[250px] md:flex md:flex-col gap-2 px-[5px] py-[25px]  rounded-lg overflow-y-auto ">
        <div
          onClick={() => signOut()}
