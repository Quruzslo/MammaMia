      ...
      >
        ...
        <div className="flex items-stretch border-b border-neutral-200 ">
          ...
          <div className="flex-1 px-5 py-4 flex justify-between items-center">
            <div>
              <p className="text-[12px] font-semibold uppercase tracking-widest text-neutral-100 mb-0.5">
                Rendelés részletei
              </p>
              <h2 className="text-base font-medium text-neutral-100  mb-0.5">
                {day.dayName}
              </h2>
              <p className="text-xs text-neutral-100">{day.date}</p>
            </div>
            ...
            <div className="flex items-center gap-[5px]">
              {day.status === "ordered" ? (
                <button
                  ...
                  className="text-[12px] font-medium hover:bg-green-600 bg-transparent text-white px-3.5 py-1.5 cursor-pointer transition-colors border border-green-600"
                ...
                <button
                  ...
                  className="text-[12px] font-medium transparent  hover:bg-neutral-50  text-neutral-100 hover:text-neutral-800  border border-neutral-300  px-3.5 py-1.5 cursor-pointer transition-colors "
                  style={{ borderRadius: "2px" }}
                >
                  Visszaállítás
                </button>
              ...
              <button
                onClick={onClose}
                className="text-[12px] font-medium text-neutral-200  border border-neutral-300  hover:bg-neutral-50 hover:text-black px-3.5 py-1.5 transition-colors cursor-pointer"
                style={{ borderRadius: "2px" }}
              >
                X
              </button>
            ...
            >
              <div className="p-[5px] ">
                <div className="flex justify-between items-center mb-1.5">
                  <span className="text-[10px] font-semibold uppercase tracking-widest text-neutral-100">
                    {item.category}
                  </span>
